                    ...
                    <div className="footer-bottom">
                        <div className="footer-bottom-info">
                            ...
                            <ul className="social-icons">
                                ...
                                <li><a href="https://www.pinterest.com/" target="_blank" rel="noopener noreferrer" className="fab fa-pinterest-p" /></li>
                                <li><a href="https://www.tiktok.com/" target="_blank" rel="noopener noreferrer" className="fab fa-tiktok" /></li>
                                <li><a href="https://www.twitter.com/" target="_blank" rel="noopener noreferrer" className="fab fa-twitter" /></li>
