            ...
            <style>
                {`
                    ...
                    .highlight-section::before {
                        ...
                        width: 5px;
                        height: 100%;
                        background: linear-gradient(180deg, #fd7e14 0%, #e8690a 100%);
                    }
                    ...
                    .blue-section .subsection-title {
                        border-left-color: #1967d2;
                        background: linear-gradient(90deg, rgba(25, 103, 210, 0.05) 0%, transparent 100%);
                    }
                ...
                <div className="section-full p-t120 p-b90">
                    <div className="terms-container">
                        ...
                        <div className="terms-content">
                            ...
                            <h2 className="section-title">ABOUT TALEGLOBAL</h2>
                            ...
                            <div className="highlight-section">
                                <h2 className="section-title">TERMS AND CONDITIONS FOR EMPLOYERS</h2>
                                
                                <h3 className="subsection-title">Registration and Verification</h3>
                                <ul>
                                ...
                                <h3 className="subsection-title">Job Posting and Process</h3>
                                <ul>
                            ...
                            <div className="highlight-section blue-section">
                                <h2 className="section-title">TERMS AND CONDITIONS FOR CANDIDATES</h2>
                                
                                <h3 className="subsection-title">Registration and Profile Creation</h3>
                                <ul>
                                ...
                                <h3 className="subsection-title">Application and Fees</h3>
                                <ul>
                                ...
                                <h3 className="subsection-title">Conduct</h3>
                                <ul>
                                ...
                                <h3 className="subsection-title">Data and Privacy</h3>
                                <ul>
                                ...
                                <h3 className="subsection-title">Liability</h3>
                                <ul>
                            ...
                            <div className="highlight-section blue-section">
                                <h2 className="section-title">TERMS AND CONDITIONS FOR CONSULTANCIES</h2>
                                ...
                                <h3 className="subsection-title">Job Posting</h3>
                                <ul>
                                ...
                                <h3 className="subsection-title">Ethical Conduct</h3>
                                <ul>
                                ...
                                <h3 className="subsection-title">Data Privacy and Protection</h3>
                                <ul>
                            ...
                            <h2 className="section-title">LEGAL COMPLIANCE AND JURISDICTION</h2>
                            ...
                            <h2 className="section-title">MODIFICATIONS AND ACCEPTANCE</h2>
                            <ul>
                            ...
                            <h2 className="section-title">TALEGLOBAL PRIVACY POLICY</h2>
                            ...
                            <div className="highlight-section">
                                <h2 className="section-title">TALEGLOBAL DISCLAIMER</h2>
                                ...
                                <h3 className="subsection-title">No Employment Guarantee</h3>
                                <ul>
                            ...
                            <h2 className="section-title">LEGAL VALIDITY AND GOVERNING LAW</h2>
                            <ul>
