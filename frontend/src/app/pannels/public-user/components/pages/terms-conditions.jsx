                        ...
                        <div className="row">
                            <div className="col-lg-12 col-md-12">
                                ...
                                <div className="wt-post-text" style={{fontFamily: 'Satoshi, sans-serif', lineHeight: '1.8'}}>
                                    ...
                                    <h2 style={{color: '#000', fontWeight: 'bold', marginTop: '30px', marginBottom: '20px', fontSize: '20px'}}>ABOUT TALEGLOBAL</h2>
                                    ...
                                    <h2 style={{color: '#000', fontWeight: 'bold', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>TERMS AND CONDITIONS FOR EMPLOYERS</h2>
                                    
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Registration and Verification</h3>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Job Posting and Process</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>TERMS AND CONDITIONS FOR CANDIDATES</h2>
                                    
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Registration and Profile Creation</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Application and Fees</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Conduct</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Data and Privacy</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Liability</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>TERMS AND CONDITIONS FOR CONSULTANCIES</h2>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Job Posting</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Ethical Conduct</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Data Privacy and Protection</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>LEGAL COMPLIANCE AND JURISDICTION</h2>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>MODIFICATIONS AND ACCEPTANCE</h2>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>TALEGLOBAL PRIVACY POLICY</h2>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>TALEGLOBAL DISCLAIMER</h2>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>No Employment Guarantee</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>Accuracy of Information</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h3 style={{color: '#333', marginTop: '25px', marginBottom: '15px', fontSize: '16px'}}>User Responsibility</h3>
                                    <ul style={{marginBottom: '20px'}}>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>LIMITATION OF LIABILITY</h2>
                                    ...
                                    <h2 style={{color: '#1967d2', marginTop: '40px', marginBottom: '20px', fontSize: '20px'}}>LEGAL VALIDITY AND GOVERNING LAW</h2>
                                    <ul style={{marginBottom: '20px'}}>
