...
export default function EmpPostedJobs() {
    ...
    useEffect(() => {
        ...
        // Then filter by search text (title, location, or company name for consultants)
					...
					<div className="mb-4 d-flex flex-wrap gap-3 justify-content-between align-items-center">
						<div className="position-relative" style={{maxWidth: '360px', flex: '1 1 300px'}}>
							...
							<input
								...
								placeholder={employerType === 'consultancy' ? "Search by title, location, or company..." : "Search by title or location..."}
								value={searchText}
