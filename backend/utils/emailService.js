...
const sendWelcomeEmail = async (email, name, userType) => {
  ...
  const welcomeTemplate = `
    <div style="font-family: Satoshi, "Satoshi Fallback";max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9fa;">
...
const sendResetEmail = async (email, resetToken, userType) => {
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Satoshi, "Satoshi Fallback";max-width: 600px; margin: 0 auto; padding: 20px;">
...
const sendAssessmentNotificationEmail = async ({ email, name, jobTitle, startDate, type }) => {
  ...
  const template = `
    <div style="font-family: Satoshi, "Satoshi Fallback";max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f7f7f9;">
        ...
        <div style="background-color: #e8f5e8; padding: 25px; border-radius: 10px; margin: 25px 0; border: 2px solid #28a745;">
          ...
          <div style="background-color: white; padding: 20px; border-radius: 8px; border: 1px solid #28a745;">
            <div style="margin-bottom: 15px;">
              ...
              <div style="background-color: #f8f9fa; padding: 12px; border-radius: 6px; font-family: Satoshi, "Satoshi Fallback";font-size: 16px; color: #2c3e50; border: 1px solid #dee2e6;">${email}</div>
            </div>
            <div>
              <label style="color: #666; font-size: 14px; font-weight: 600; display: block; margin-bottom: 5px;">Password:</label>
              <div style="background-color: #f8f9fa; padding: 12px; border-radius: 6px; font-family: Satoshi, "Satoshi Fallback";font-size: 16px; color: #2c3e50; border: 1px solid #dee2e6; font-weight: bold;">${password}</div>
            </div>
          </div>
        </div>
