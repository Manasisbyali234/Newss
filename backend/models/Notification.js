...
const notificationSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ['profile_submitted', 'job_posted', 'application_received', 'application_status_updated', 'profile_approved', 'profile_rejected', 'interview_scheduled', 'interview_updated', 'profile_completion', 'file_uploaded', 'placement_processed', 'document_approved', 'document_rejected', 'support_response', 'file_processed', 'file_rejected', 'bulk_approval_completed', 'placement_approved'], required: true },
